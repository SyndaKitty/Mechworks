...
public class BeltManager2D : MonoBehaviour
{
    public TickInfo TickInfo;
    readonly Dictionary<Vector3Int, ConveyorBelt2D> belts = new Dictionary<Vector3Int, ConveyorBelt2D>();
    ...
    readonly Dictionary<Vector3Int, ItemMovement2D> movementLookup = new Dictionary<Vector3Int, ItemMovement2D>();
    readonly List<ItemMovement2D> ItemMovements = new List<ItemMovement2D>();
    ...
    public void BlockMovement(Vector3Int origin)
    {
        ...
        while (originsToBeProcessed.Count > 0)
        {
            ...
            foreach (var dir in DirectionExtensions2D.Directions())
            {
    ...
    public bool Register(ConveyorBelt2D belt)
    {
